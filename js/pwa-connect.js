          ...
          api.Admin.dashboard()
            .then(function (data) {
              ...
              if (Array.isArray(slots)) {
                var tier1El = document.querySelector('[data-promo-slots-tier1]');
                var tier2El = document.querySelector('[data-promo-slots-tier2]');
                var tier3El = document.querySelector('[data-promo-slots-tier3]');
